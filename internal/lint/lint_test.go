...
func TestRunFindsOrphanAndCheckedParentWarnings(t *testing.T) {
	...
	if !codes["checked_parent_open_subtask"] {
		t.Fatalf("expected checked_parent_open_subtask in %#v", findings)
	}
